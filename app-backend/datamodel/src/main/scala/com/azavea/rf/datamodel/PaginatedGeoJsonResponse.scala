...
object GeoJsonCodec {
  ...
  def fromSeqToFeatureCollection[T1 <: GeoJSONSerializable[T2], T2 <: GeoJSONFeature](
  ...
  def fromPaginatedResponseToGeoJson[T1 <: GeoJSONSerializable[T2], T2 <: GeoJSONFeature](

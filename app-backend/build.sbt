...
lazy val apiDependencies = Seq(
  ...
  Dependencies.catsCoreBatch,
  Dependencies.catsEffect,
  Dependencies.catsFree,
  Dependencies.catsKernelBatch,
  ...
  Dependencies.geotrellisVectorBatch,
  Dependencies.guava,
...
lazy val batch = project
  ...
  .settings({
    libraryDependencies ++= Seq(
      ...
      Dependencies.geotrellisProj4Batch,
      Dependencies.geotrellisRaster,
      Dependencies.geotrellisUtilBatch,
      Dependencies.geotrellisVectorBatch,
      Dependencies.guava,
      Dependencies.hadoop,
      Dependencies.hikariCP,

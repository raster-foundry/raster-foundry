...
trait MapAlgebraOperationCodecs extends MapAlgebraUtilityCodecs {
    ...
    Decoder.instance[MapAlgebraAST.Operation] { ma =>
      ma._symbol match {
        ...
        case Some(unrecognized) =>
          Left(
            DecodingFailure(s"Unrecognized node type: $unrecognized",
                            ma.history))
        case None =>
          Left(
            DecodingFailure(
              "The property 'apply' is mandatory on all AST operations",
              ma.history))
      }
    }
      ...
      final def apply(op: MapAlgebraAST.Operation): Json = op match {
        ...
        case operation =>
          throw new InvalidParameterException(
            s"Encoder for $operation not yet implemented")
      }
    }
  ...
  implicit lazy val encodeAddition: Encoder[MapAlgebraAST.Addition] =
    Encoder.forProduct4("apply", "args", "id", "metadata")(op =>
      (op.symbol, op.args, op.id, op.metadata))

  implicit lazy val decodeSubtraction: Decoder[MapAlgebraAST.Subtraction] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.Subtraction.apply)
  ...
  implicit lazy val decodeMultiplication
    : Decoder[MapAlgebraAST.Multiplication] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.Multiplication.apply)
  implicit lazy val encodeMultiplication
    : Encoder[MapAlgebraAST.Multiplication] =
    Encoder.forProduct4("apply", "args", "id", "metadata")(op =>
      (op.symbol, op.args, op.id, op.metadata))

  implicit lazy val decodeMasking: Decoder[MapAlgebraAST.Masking] =
    Decoder.forProduct4("args", "id", "metadata", "mask")(
      MapAlgebraAST.Masking.apply)
  implicit lazy val encodeMasking: Encoder[MapAlgebraAST.Masking] =
    Encoder.forProduct5("apply", "args", "id", "metadata", "mask")(op =>
      (op.symbol, op.args, op.id, op.metadata, op.mask))

  implicit lazy val decodeClassification
    : Decoder[MapAlgebraAST.Classification] =
    Decoder.forProduct4("args", "id", "metadata", "classMap")(
      MapAlgebraAST.Classification.apply)
  implicit lazy val encodeClassification
    : Encoder[MapAlgebraAST.Classification] =
    Encoder.forProduct5("apply", "args", "id", "metadata", "classMap")(op =>
      (op.symbol, op.args, op.id, op.metadata, op.classMap))
  ...
  implicit lazy val decodeFocalMax: Decoder[MapAlgebraAST.FocalMax] =
    Decoder.forProduct4("args", "id", "metadata", "neighborhood")(
      MapAlgebraAST.FocalMax.apply)
  implicit lazy val encodeFocalMax: Encoder[MapAlgebraAST.FocalMax] =
    Encoder.forProduct5("apply", "args", "id", "metadata", "neighborhood")(op =>
      (op.symbol, op.args, op.id, op.metadata, op.neighborhood))

  implicit lazy val decodeFocalMin: Decoder[MapAlgebraAST.FocalMin] =
    Decoder.forProduct4("args", "id", "metadata", "neighborhood")(
      MapAlgebraAST.FocalMin.apply)
  ...
  implicit lazy val decodeFocalMedian: Decoder[MapAlgebraAST.FocalMedian] =
    Decoder.forProduct4("args", "id", "metadata", "neighborhood")(
      MapAlgebraAST.FocalMedian.apply)
  ...
  implicit lazy val decodeFocalStdDev: Decoder[MapAlgebraAST.FocalStdDev] =
    Decoder.forProduct4("args", "id", "metadata", "neighborhood")(
      MapAlgebraAST.FocalStdDev.apply)
  ...
  implicit lazy val decodeLogicalNegation
    : Decoder[MapAlgebraAST.LogicalNegation] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.LogicalNegation.apply)
  implicit lazy val encodeLogicalNegation
    : Encoder[MapAlgebraAST.LogicalNegation] =
    Encoder.forProduct4("apply", "args", "id", "metadata")(op =>
      (op.symbol, op.args, op.id, op.metadata))
  ...
  implicit lazy val decodeLogicallyExclusiveDisjunction
    : Decoder[MapAlgebraAST.Xor] =
    Decoder.forProduct3("args", "id", "metadata")(MapAlgebraAST.Xor.apply)
  implicit lazy val encodeLogicallyExclusiveDisjunction
    : Encoder[MapAlgebraAST.Xor] =
    Encoder.forProduct4("apply", "args", "id", "metadata")(op =>
      (op.symbol, op.args, op.id, op.metadata))
  ...
  implicit lazy val decodeGreaterOrEqual
    : Decoder[MapAlgebraAST.GreaterOrEqual] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.GreaterOrEqual.apply)
  implicit lazy val encodeGreaterOrEqual
    : Encoder[MapAlgebraAST.GreaterOrEqual] =
    Encoder.forProduct4("apply", "args", "id", "metadata")(op =>
      (op.symbol, op.args, op.id, op.metadata))
  ...
  implicit lazy val decodeInequality: Decoder[MapAlgebraAST.Inequality] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.Inequality.apply)
  ...
  implicit lazy val decodeLessOrEqual: Decoder[MapAlgebraAST.LessOrEqual] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.LessOrEqual.apply)
  ...
  implicit lazy val decodeSquareRoot: Decoder[MapAlgebraAST.SquareRoot] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.SquareRoot.apply)
  ...
  implicit lazy val decodeNumericNegation
    : Decoder[MapAlgebraAST.NumericNegation] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.NumericNegation.apply)
  implicit lazy val encodeNumericNegation
    : Encoder[MapAlgebraAST.NumericNegation] =
    Encoder.forProduct4("apply", "args", "id", "metadata")(op =>
      (op.symbol, op.args, op.id, op.metadata))
  ...
  implicit lazy val decodeIsUndefined: Decoder[MapAlgebraAST.IsUndefined] =
    Decoder.forProduct3("args", "id", "metadata")(
      MapAlgebraAST.IsUndefined.apply)

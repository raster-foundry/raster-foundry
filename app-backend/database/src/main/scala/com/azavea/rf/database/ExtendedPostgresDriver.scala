...
trait ExtendedPostgresDriver extends ExPostgresDriver
  ...
  object RFAPI extends API
    ...
    implicit def intListTypeMapper = new SimpleArrayJdbcType[Int]("int").to(_.toList)

    implicit val uriTypeMapper = createEnumJdbcType[URI]("URI",
      _.toString, URI.create, quoteName = false)
    implicit val uriTypeListMapper = createEnumListJdbcType[URI]("URI",
      _.toString, URI.create, quoteName = false)
    implicit val uriColumnExtensionMethodsBuilder =
      createEnumColumnExtensionMethodsBuilder[URI]
    implicit val uriOptionColumnExtensionMethodsBuilder =
      createEnumOptionColumnExtensionMethodsBuilder[URI]

    implicit val userRoleTypeMapper = createEnumJdbcType[User.Role]("UserRole",
    ...
    implicit val jobStatusTypeMapper = createEnumJdbcType[JobStatus]("JobStatus",
    ...
    implicit val visibilityTypeMapper = createEnumJdbcType[Visibility]("Visibility",
      _.repr, Visibility.fromString, quoteName = false)
    implicit val visibilityTypeListMapper = createEnumListJdbcType[Visibility]("Visibility",
      _.repr, Visibility.fromString, quoteName = false)
    ...
    implicit val thumbnailDimTypeMapper = createEnumJdbcType[ThumbnailSize]("ThumbnailSize",
      _.toString, ThumbnailSize.fromString, quoteName = false)
    implicit val thumbnailDimTypeListMapper = createEnumListJdbcType[ThumbnailSize]("ThumbnailSize",
      _.toString, ThumbnailSize.fromString, quoteName = false)

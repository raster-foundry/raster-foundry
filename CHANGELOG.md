...
- Update platform/org/team/user related migration, dao, datamodel, property test [\#3299](https://github.com/raster-foundry/raster-foundry/pull/3299)
- Update export definition on an export when we create it [\#3295](https://github.com/raster-foundry/raster-foundry/pull/3295)
- Add authorization to all project endpoints [\#3292](https://github.com/raster-foundry/raster-foundry/pull/3292)
...
- Use a fresh platform in OrganizationDao tests [\#3268](https://github.com/raster-foundry/raster-foundry/pull/3268)
- Add PlatformDao property tests [\#3264](https://github.com/raster-foundry/raster-foundry/pull/3264)
- Use Spark Local for Exports [\#3259](https://github.com/raster-foundry/raster-foundry/pull/3259)
- \[Platforms\] Add property tests for teamDao [\#3257](https://github.com/raster-foundry/raster-foundry/pull/3257)
...
- Add a migration for platform and organization management [\#3252](https://github.com/raster-foundry/raster-foundry/pull/3252)
...
- Enable text search in workspace, template, project and function in Lab [\#3235](https://github.com/raster-foundry/raster-foundry/pull/3235)
...
- Add property test for WorkspaceDao [\#3229](https://github.com/raster-foundry/raster-foundry/pull/3229)
...
- \[Platforms\] Add datamodels, DAO, and spec for access-control-rules [\#3185](https://github.com/raster-foundry/raster-foundry/pull/3185)
- Delete datasource after updating scenes [\#3177](https://github.com/raster-foundry/raster-foundry/pull/3177)
- Add most LayerAttributeDao tests [\#3174](https://github.com/raster-foundry/raster-foundry/pull/3174)
- Add checklist item to PR template for APP\_NAME templating [\#3173](https://github.com/raster-foundry/raster-foundry/pull/3173)
- Add SceneWithRelatedDao property tests [\#3171](https://github.com/raster-foundry/raster-foundry/pull/3171)
- Add scene dao tests [\#3161](https://github.com/raster-foundry/raster-foundry/pull/3161)
- Add AoiDao property tests [\#3158](https://github.com/raster-foundry/raster-foundry/pull/3158)
- \[Platforms\] Add datamodel, DAO, and spec for user-group-roles [\#3156](https://github.com/raster-foundry/raster-foundry/pull/3156)
- Add property tests for UploadDao [\#3154](https://github.com/raster-foundry/raster-foundry/pull/3154)
...
- Add property tests for ThumbnailDao [\#3150](https://github.com/raster-foundry/raster-foundry/pull/3150)
- Add property tests for ShapeDao [\#3149](https://github.com/raster-foundry/raster-foundry/pull/3149)
- Add property tests for datasource dao [\#3148](https://github.com/raster-foundry/raster-foundry/pull/3148)
- Add AnnotationDao property tests [\#3147](https://github.com/raster-foundry/raster-foundry/pull/3147)
...
- Add property tests for ProjectDao methods [\#3143](https://github.com/raster-foundry/raster-foundry/pull/3143)
- Add shape filter to scenes in api and hook up frontend [\#3142](https://github.com/raster-foundry/raster-foundry/pull/3142)
- Add property tests for band and image daos [\#3138](https://github.com/raster-foundry/raster-foundry/pull/3138)
- Add property tests for OrganizationDao interactions [\#3135](https://github.com/raster-foundry/raster-foundry/pull/3135)
- \[Anchor\] Add property tests for Dao interactions [\#3134](https://github.com/raster-foundry/raster-foundry/pull/3134)
- \[Platforms\] Add team datamodel, dao, and routes [\#3127](https://github.com/raster-foundry/raster-foundry/pull/3127)
- Update pull request template [\#3126](https://github.com/raster-foundry/raster-foundry/pull/3126)
- \[Platforms\] Add platform datamodel, DAO, DAOSpec, and Routes [\#3125](https://github.com/raster-foundry/raster-foundry/pull/3125)

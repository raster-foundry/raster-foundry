package com.azavea.rf.datamodel.v19.schema
...
trait tables {
   ...
   *  @param name Database column name SqlType(varchar), Length(255,true)
   *  @param footprint Database column footprint SqlType(geometry), Length(2147483647,false), Default(None) */
  case class ScenesRow(id: java.util.UUID, createdAt: java.sql.Timestamp, modifiedAt: java.sql.Timestamp, organizationId: java.util.UUID, createdBy: String, modifiedBy: String, ingestSizeBytes: Int, visibility: Visibility, resolutionMeters: Float, tags: List[String], datasource: String, sceneMetadata: Map[String, Any], cloudCover: Option[Float] = None, acquisitionDate: Option[java.sql.Timestamp] = None, thumbnailStatus: JobStatus, boundaryStatus: JobStatus, status: JobStatus, sunAzimuth: Option[Float] = None, sunElevation: Option[Float] = None, name: String, footprint: Option[Projected[Geometry]] = None)
  /** GetResult implicit for fetching ScenesRow objects using plain SQL queries */
  implicit def GetResultScenesRow(implicit e0: GR[java.util.UUID], e1: GR[java.sql.Timestamp], e2: GR[String], e3: GR[Int], e4: GR[Visibility], e5: GR[Float], e6: GR[List[String]], e7: GR[Map[String, Any]], e8: GR[Option[Float]], e9: GR[Option[java.sql.Timestamp]], e10: GR[JobStatus], e11: GR[Option[Projected[Geometry]]]): GR[ScenesRow] = GR{
    prs => import prs._
    ScenesRow.tupled((<<[java.util.UUID], <<[java.sql.Timestamp], <<[java.sql.Timestamp], <<[java.util.UUID], <<[String], <<[String], <<[Int], <<[Visibility], <<[Float], <<[List[String]], <<[String], <<[Map[String, Any]], <<?[Float], <<?[java.sql.Timestamp], <<[JobStatus], <<[JobStatus], <<[JobStatus], <<?[Float], <<?[Float], <<[String], <<?[Projected[Geometry]]))
  }
  ...
  class Scenes(_tableTag: Tag) extends Table[ScenesRow](_tableTag, "scenes") {
    def * = (id, createdAt, modifiedAt, organizationId, createdBy, modifiedBy, ingestSizeBytes, visibility, resolutionMeters, tags, datasource, sceneMetadata, cloudCover, acquisitionDate, thumbnailStatus, boundaryStatus, status, sunAzimuth, sunElevation, name, footprint) <> (ScenesRow.tupled, ScenesRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(createdAt), Rep.Some(modifiedAt), Rep.Some(organizationId), Rep.Some(createdBy), Rep.Some(modifiedBy), Rep.Some(ingestSizeBytes), Rep.Some(visibility), Rep.Some(resolutionMeters), Rep.Some(tags), Rep.Some(datasource), Rep.Some(sceneMetadata), cloudCover, acquisitionDate, Rep.Some(thumbnailStatus), Rep.Some(boundaryStatus), Rep.Some(status), sunAzimuth, sunElevation, Rep.Some(name), footprint).shaped.<>({r=>import r._; _1.map(_=> ScenesRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10.get, _11.get, _12.get, _13, _14, _15.get, _16.get, _17.get, _18, _19, _20.get, _21)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column name SqlType(varchar), Length(255,true) */
    val name: Rep[String] = column[String]("name", O.Length(255,varying=true))
    /** Database column footprint SqlType(geometry), Length(2147483647,false), Default(None) */
  ...
  case class ThumbnailsRow(id: java.util.UUID, createdAt: java.sql.Timestamp, modifiedAt: java.sql.Timestamp, organizationId: java.util.UUID, widthPx: Int, heightPx: Int, scene: java.util.UUID, url: String, thumbnailSize: ThumbnailSize)
  /** GetResult implicit for fetching ThumbnailsRow objects using plain SQL queries */
  implicit def GetResultThumbnailsRow(implicit e0: GR[java.util.UUID], e1: GR[java.sql.Timestamp], e2: GR[Int], e3: GR[String], e4: GR[ThumbnailSize]): GR[ThumbnailsRow] = GR{
    prs => import prs._
    ThumbnailsRow.tupled((<<[java.util.UUID], <<[java.sql.Timestamp], <<[java.sql.Timestamp], <<[java.util.UUID], <<[Int], <<[Int], <<[java.util.UUID], <<[String], <<[ThumbnailSize]))
  }
  ...
  class Thumbnails(_tableTag: Tag) extends Table[ThumbnailsRow](_tableTag, "thumbnails") {
    def * = (id, createdAt, modifiedAt, organizationId, widthPx, heightPx, scene, url, thumbnailSize) <> (ThumbnailsRow.tupled, ThumbnailsRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(createdAt), Rep.Some(modifiedAt), Rep.Some(organizationId), Rep.Some(widthPx), Rep.Some(heightPx), Rep.Some(scene), Rep.Some(url), Rep.Some(thumbnailSize)).shaped.<>({r=>import r._; _1.map(_=> ThumbnailsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

package com.azavea.rf.datamodel.v10.schema
...
trait tables {
  ...
  lazy val schema: profile.SchemaDescription = Array(Buckets.schema, Organizations.schema, Scenes.schema, ScenesToBuckets.schema, Users.schema, UsersToOrganizations.schema).reduceLeft(_ ++ _)

...
MapSearchModalModule.controller('MapSearchModalController', MapSearchModalController);
MapSearchModalModule.component('rfMapSearchModal', MapSearchModalComponent);

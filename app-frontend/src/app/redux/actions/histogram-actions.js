            ...
            dispatch({
                ...
                .then(({ value: response }) => {
                    ...
                    if (!nodeDefinition.metadata.renderDefinition) {
                        let { renderDefinition, histogramOptions } = createRenderDefinition(
                            histogram
                        );
                        let newNodeDefinition = Object.assign({}, nodeDefinition, {
        ...
        const newNodeDefinition = Object.assign({}, nodeDefinition, {
            metadata: Object.assign({}, nodeDefinition.metadata, {
                ...
                histogramOptions: histogramOptions
                    ? histogramOptions
                    : nodeDefinition.metadata.histogramOptions
            })
        });

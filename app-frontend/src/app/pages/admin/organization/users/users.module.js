...
class OrganizationUsersController {
                ...
                },
                {
                    ...
                    callback: () => {
                        this.organizationService
                            .removeUser(this.platform.id, this.organization.id, user.id)
                            .then(() => {
    ...
    updateUserGroupRole(user) {
        return this.organizationService
            .setUserRole(this.organization.platformId, this.organization.id, user)
            .catch(() => {
    ...
    updateUserMembershipStatus(user, isApproved) {
        if (isApproved) {
            ...
            this.organizationService
                .removeUser(this.organization.platformId, this.organization.id, user.id)
                .then(resp => {

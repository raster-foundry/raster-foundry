    ...
    class ColorSchemeService {
        ...
        matchSingleBandOptions(singleBandOptions) {
            ...
            let found = this.defaultColorSchemes.find(
                scheme =>
                    scheme.type === singleBandOptions.dataType &&
                    _.isEqual(this.colorStopsToProportionalArray(scheme.colors), targetScheme)
            );
        ...
        colorsToBackground(colors, direction = 90, bins = 0, reversed) {
            ...
            const colorString =
                bins > 0 ? this.toBinnedColors(colorsArray) : colorsArray.join(', ');
            const style = {

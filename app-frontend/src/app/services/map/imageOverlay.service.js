        ...
        createNewImageOverlay(url, bounds, options) {
            ...
            let ImageOverlayLayer = L.ImageOverlay.extend({
                ...
                _initImage: function() {
                    ...
                    let clipPath = defs.append('clipPath').attr('id', this.id);

                    results.forEach(r => {
                        clipPath.append('polygon').attr('points', r);
                    });
                },
                ...
                _reset: function() {
                    ...
                    this.svg.attr('width', size.x).attr('height', size.y);
                },
                onRemove: function() {
